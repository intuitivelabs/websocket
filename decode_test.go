...
func TestDecoderCompressed(t *testing.T) {
	...
	// https://www.rfc-editor.org/rfc/rfc7692.html#section-7.2.3.2 stateful
	t.Run("rfc7692 sharing LZ77 sliding window", func(t *testing.T) {
		message := NewMessage(64535, 10, true)
		compressedPkts := [][]byte{
			/* first message */
			{
				0xc1, 0x07, 0xf2, 0x48, 0xcd, 0xc9, 0xc9, 0x07,
